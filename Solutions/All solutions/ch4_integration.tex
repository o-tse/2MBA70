...
\begin{align*}
	\sum_{i = 1}^N a_i \mu(A_i) &= \sum_{i = 1}^N a_i \mu(\bigcup_{j = 1}^M A_i \cap B_j)\\
	&= \sum_{i = 1}^N a_i \sum_{j = 1}^M \mu(A_i \cap B_j) \\
	&= \sum_{i = 1}^N \sum_{j = 1}^M a_i \mu(A_i \cap B_j) \\
	&= \sum_{i = 1}^N \sum_{j = 1}^M b_i \mu(A_i \cap B_j) \\
	&= \sum_{j = 1}^M b_j \mu(\bigcup_{i = 1}^N A_i \cap B_j) = \sum_{j = 1}^M b_j \mu(B_j).
\end{align*}
...
\textbf{Problem 4.7} \rubric{Total point: 9}
...
\item \rubric{ Total points: 2 \hfill
	...
	\hline
	Write positive and negative part of $f \mathbbm{1}_{B}$ in terms of positive and negative part of $f$ & 1pt\\
	Use definition and Lemma 4.8 to conclude & 2pt\\
	\hline
	\end{tabular}
...
\item \rubric{ Total points: 2 \hfill
	...
	\begin{tabular}{p{0.8\linewidth}p{0.15\linewidth}}
	\hline
	Use inequality of $f$ and $g$ to obtain inequalities for positive and negative part & 1pt\\
	Use definition and Lemma 4.8 to conclude & 2pt\\
	\hline
	\end{tabular}
...
\item \rubric{ Total points: 3 \hfill
	...
	\begin{tabular}{p{0.8\linewidth}p{0.15\linewidth}}
	\hline
	Use Lemma 4.8 to obtain result for non-negative $\alpha$ & 1pt\\
	Write positive and negative part of $-f$ in terms of positive and negative part of $f$ & 1pt\\
	Conclude & 1pt\\
	\hline
	\end{tabular}
...
\item \rubric{ Total points: 2 \hfill
	...
	\begin{tabular}{p{0.8\linewidth}p{0.15\linewidth}}
	\hline
	Write positive and negative part of $f + g$ in terms of positive and negative part of $f$ and $g$ & 1pt\\
	Use definition and Lemma 4.8 to conclude & 1pt\\
	\hline
	\end{tabular}
