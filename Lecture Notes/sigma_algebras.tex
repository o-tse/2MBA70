...
Still, it turns out that such a measure exists. This fundamental measure is called the \emph{Lebesgue measure} and, in addition to the property mentioned above, has several other strong features.
...
Prove Lemma~\ref{lem:sigma_subadditive}
\end{problem}
